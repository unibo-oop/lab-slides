...
\item Accedere al PC di laboratorio con le proprie credenziali istituzionali
	...
	\item Decomprimere il file e aprire con Atom la directory ottenuta (File $>$ Add Project Folder...)
...
\begin{frame}[allowframebreaks]{Il classpath in Java}
	\begin{itemize}
		...
		\end{itemize}
	\end{itemize}
	\begin{block}{Come fa la JVM a risolvere le classi? \cite{or-java}}
		\begin{itemize}
