...
\fg{height=0.7\textheight}{img/topIDE2015.png}
Dati aggiornati a Luglio 2015\\\footnotesize{(fonte: \url{knoema.com/jtieieg/popularity-of-programming-languages})}
\end{frame}
...
\fr{Eclipse Overview}{
	...
	\bl{Un po' di storia}{
		\iz{
			...
			\item	Successivamente	donato alla comunità open-source che ora ne cura lo sviluppo per mezzo di una apposita fondazione
...
\fr{Avvio di Eclipse: Scelta del Workspace}{
	\fg{height=0.8\textheight}{img/eclipse_startup.png}	
}
