...
\fr{Preparazione Ambiente di Lavoro 1/2}{
	\iz{
		...
		\item Scaricare dalla sezione \texttt{lab} del sito il file \texttt{oop-lab03.zip} contenente il materiale dell'esercitazione odierna
...
\fr{Preparazione Ambiente di Lavoro 2/2}{
	\iz{
		...
		\item Importare il progetto \texttt{OOP-LAB} con la procedura di importazione dei progetti mostrata nelle slide precedenti
...
\fr{\cil{oop.lab03.encapsulation.BankAccount} 1/2}{
...
\fr{\cil{oop.lab03.encapsulation.BankAccount} 2/2}{
...
\fr{Test di BankAccount}{
	\bl{}{
		Effettuare il testing della classe \cil{BankAccount} appena implementata seguendo le indicazioni fornite nei commenti in \cil{oop.lab03.encapsulation.TestBankAccount} 
	}
}

\fr{\cil{oop.lab03.interfaces.IBankAccount} 1/2}{
	\bl{}{
	...
	\bl{\cil{oop.lab03.interfaces.IBankAccount}}{
		\sizedcode{\scriptsize}{code/IBankAccount.java}
	}
}	

\fr{\cil{oop.lab03.interfaces.IBankAccount} 2/2}{
...
\fr{\cil{BankAccount e StrictBankAccount: Test}}{	
		\bl{}{
			Effettuare il testing delle classi \cil{BankAccount} e \cil{StrictBankAccount} appena implementate seguendo le indicazioni fornite nei commenti in \cil{oop.lab03.interfaces.TestIBankAccount} 
		}
}
...
\fr{IShape: Un' Interfaccia per Modellare Figure Geometriche}{
        \bl{\cil{oop.lab03.interfaces.IShape.java}}{Realizzare \textbf{da zero} un'interfaccia che consenta di calcolare \textbf{area} e \textbf{perimetro} di una qualsivoglia \textbf{figura geometrica}}
...
\fr{Estensione per Figure con Lati Limitati}{
	...
	\bl{Realizzare \cil{oop.lab03.interfaces.IShapeWithLimitedEdges} che estende \cil{IShape}}{
		\iz{
