...
\begin{frame}[fragile, allowframebreaks]{Lavorare in parallelo}
    Cosa succede se i due repository evolvono concorrentemente?
    \framebreak{}
	...
	\texttt{git push indirizzo\_di\_remote\_repo} \\
	\begin{center}
		\includegraphics[width=0.75\textwidth]{img/draw10}
	\end{center}
\end{frame}
...
\fr{GitHub Overview}{
	\includegraphics[width=0.99\textwidth]{img/github1}
}

\fr{GitHub Overview}{
	\includegraphics[width=0.99\textwidth]{img/github2}
}

\fr{GitHub Overview}{
	\includegraphics[width=0.99\textwidth]{img/github3}
}

\fr{GitHub Overview}{
	\includegraphics[width=0.99\textwidth]{img/github4}
}

\fr{GitHub Overview}{
	\includegraphics[width=0.99\textwidth]{img/github5}
}

\fr{GitHub Overview}{
	\includegraphics[width=0.99\textwidth]{img/github6}
}

\fr{GitHub Overview}{
	\includegraphics[width=0.99\textwidth]{img/github7}
}

\fr{GitHub Overview}{
	\includegraphics[width=0.8\textwidth]{img/github9}
...
\begin{frame}[fragile, allowframebreaks]{Elenco non completo di aspetti che non abbiamo visto}
  \bl{Bisection}{
  ...
  \bl{Plumbing}{
    Accesso alla rappresentazione dei dati interna di Git (solitamente per la scrittura di software di automazione).
  }
  \bl{Rebasing}{
  ...
  \bl{Signing}{
    Firma digitale di commit (e tag).
  }
  \bl{Squashing}{
    Compressione di più commit in un solo commit.
  }
  \bl{Stashing}{
    Salvataggio di modifiche senza commit in uno stack dedicato.
  }
  \bl{Patching}{
    Creazione ed applicazione di patch files.
  }
  \bl{Tagging}{
    Associazione di nomi simbolici ai commit (solitamente usato per creare release).
  }
  (alcuni di questi aspetti avanzati si toccano in un opzionale all'ultimo anno di magistrale)
\end{frame}
...
\begin{frame}{Importanza del testing}
	...
	\begin{itemize}
		...
		\item Subito dopo le interfacce si dovrebbero scrivere i test, e solo dopo implementare il sistema
		\begin{itemize}
...
\begin{frame}[allowframebreaks]{Unit vs integration}
	\begin{block}{Unit testing}
		...
		\end{itemize}
	\end{block}
	\begin{block}{Integration ed end-to-end testing}
		\begin{itemize}
