...
\end{itemize}
\item \url{https://openjfx.io/javadoc/17/javafx.graphics/javafx/stage/Stage.html}
\end{itemize}
\end{block}
...
\item \url{https://openjfx.io/javadoc/17/javafx.graphics/javafx/scene/Scene.html}
\end{itemize}
\end{block}
\end{frame}
...
\\ \url{https://openjfx.io/javadoc/17/javafx.graphics/javafx/application/Application.html}
\end{itemize}
\end{block}
...
\item Invocazione medoto \texttt{start(javafx.stage.Stage)}
...
\item \url{https://openjfx.io/javadoc/17/javafx.graphics/javafx/scene/Node.html}
\end{itemize}
\end{block}
\end{frame}
