...
\fr{Java Development Kit (JDK)}{
    \bl{Esistono diverse distribuzioni di Java}{
        \begin{description}
            ...
            \item[Jakarta EE] -- (ex Java Enterprise Edition) JDK + set esteso di librerie
        \end{description}
    }
...
\fr{Java Development Kit (JDK)}{
    \begin{itemize}
        \item Java 17 -- (pen)ultima versione LTS del JDK
        \begin{itemize}
            \item Esistono varie versioni e vari distributori (OpenJDK, Oracle JDK, Eclipse OpenJ9, Amazon, Graal, Zulu\dots)
            \item \textbf{OpenJDK} -- implementazione non commerciale, \emph{reference version}
            \begin{itemize}
    ...
    \begin{block}{Riferimenti per il corso}
        \begin{itemize}
            ...
            \item Java 17, distribuita da Adoption %OpenJDK            
