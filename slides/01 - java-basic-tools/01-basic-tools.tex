...
\begin{itemize}
\item Distribuzione Oracle -- versione (ufficiale) commerciale di Java
\item Distribuzione OpenJDK -- implementazione non commerciale, riferimento de facto
\end{itemize}
\end{itemize}
...
\begin{itemize}
\item Java 11
\item Distribuzione OpenJDK
\begin{itemize}
\item \texttt{https://openjdk.java.net/}
\end{itemize}
...
\fr{Preparazione Ambiente di Lavoro (1/4)}{
	\iz{
		...
		\iz{
			\item \textcolor{blue}{\url{https://bit.ly/2P4HYiQ}}
		}
...
\end{itemize}
\item Si suggerisce l'utilizzo di Atom (\texttt{https://atom.io/})
\begin{itemize}
