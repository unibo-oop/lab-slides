...
\fr{Sulle feature branch} {
        \iz {
            ...
            \item In questi contesti può aiutare a tener traccia dello stato di avanzamento di determinate attività
...
\iz{
    ...
    \item Creerà quindi il repo su BitBucket, per esempio
