...
\fr{Preparazione Ambiente di Lavoro}{
  \iz{
    ...
    \item Importare il la cartella \texttt{lab05} come progetto all'interno di Eclipse
  }
}
...
\fr{Java: i file JAR}{
  \iz {
    ...
    \item Normalmente, le applicazioni Java vengono confezionate in JAR files
  }
  \bl{Cos'è?} {
    \iz {
      \item Un JAR è un archivio (normalmente compresso) che contiene le classi, le risorse (e.g. icone) e un file descrittivo detto ``ManifGest''
...
\fr {Generazione di JAR files con Eclipse} {
...
\imgfr{Generazione di JAR files con Eclipse}{Selezionare le risorse da esportare, click destro ed \texttt{Export}}{0.3}{img/exportjar1}
\imgfr{Generazione di JAR files con Eclipse}{}{0.6}{img/exportjar2}
\imgfr{Generazione di JAR files con Eclipse}{}{0.6}{img/exportjar3}
\imgfr{Generazione di JAR files con Eclipse}{}{0.6}{img/exportjar4}
\imgfr{Generazione di JAR files con Eclipse}{Espandere l'elenco dei file}{0.4}{img/exportjar5}
\imgfr{Generazione di JAR files con Eclipse}{Verificare \textbf{sempre} che siano selezionate \textbf{tutte e sole} le risorse che ci interessano.}{0.5}{img/exportjar6}
\imgfr{Generazione di JAR files con Eclipse}{Eventualmente potete esportare anche i sorgenti}{0.5}{img/exportjar7}
\imgfr{Generazione di JAR files con Eclipse}{Inserite il nome del file (e selezionate la cartella dove volete creare il JAR)}{0.5}{img/exportjar8}
\imgfr{Generazione di JAR files con Eclipse}{Finish}{0.5}{img/exportjar9}

\fr {Verifica del contenuto di un JAR da riga di comando} {
       Si verifichi il contenuto del JAR file con \texttt{jar tf myjar.jar}
  }

\fr {Generazione di JAR files eseguibili con Eclipse} {
...
\imgfr{Generazione di JAR files eseguibili con Eclipse}{}{0.99}{img/exportrunnablejar1}
\imgfr{Generazione di JAR files eseguibili con Eclipse}{}{0.3}{img/exportrunnablejar2}
\imgfr{Generazione di JAR files eseguibili con Eclipse}{}{0.4}{img/exportrunnablejar3}
\imgfr{Generazione di JAR files eseguibili con Eclipse}{Selezionare le risorse di interesse}{0.99}{img/exportrunnablejar4}
\imgfr{Generazione di JAR files eseguibili con Eclipse}{}{0.3}{img/exportrunnablejar5}
\imgfr{Generazione di JAR files eseguibili con Eclipse}{}{0.7}{img/exportrunnablejar6}
\imgfr{Generazione di JAR files eseguibili con Eclipse}{Selezionare la la ``Run configuration'' da utilizzare}{0.7}{img/exportrunnablejar7}
\imgfr{Generazione di JAR files eseguibili con Eclipse}{Inserire il nome del file (e selezionare il path in cui si desidera crearlo)}{0.7}{img/exportrunnablejar8}
\imgfr{Generazione di JAR files eseguibili con Eclipse}{Finish}{0.7}{img/exportrunnablejar9}
...
\fr{Javadoc: Linee Guida d'Uso}{
  \bl{Cosa commentare e quali tag usare?}{
    \iz{
      ...
      \item Non è necessario documentare metodi di cui si fa override, a meno che non vi siano peculiarità non rilevate nella documentazione della superclasse.
    }
  }
  \bl{}{
...
\imgfr{Generazione di JAR files eseguibili con Eclipse}{}{0.3}{img/exportrunnablejar5}
\imgfr{Generazione di JAR files eseguibili con Eclipse}{}{0.7}{img/exportrunnablejar6}
\imgfr{Generazione UML del modellodi JAR files eseguibili con Eclipse}{Selezionare la la ``Run configuration'' da utilizzare}{0.7}{img/exportrunnablejar7}
\imgfr{Generazione di JAR files eseguibili con Eclipse}{Inserire il nome del file (e selezionare il path in cui si desidera crearlo)}{0.7}{img/exportrunnablejar8}
\imgfr{Generazione di JAR files eseguibili con Eclipse}{Finish}{0.7}{img/exportrunnablejar9}
