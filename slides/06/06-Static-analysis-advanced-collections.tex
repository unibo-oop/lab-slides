...
\title[OOP\lessonnr{} -- Collections II, enumerations, nested classes]{\lessonnr{}\\ Jar, collezioni avanzate, enumeration e classi nested}
...
\fr{Checkstyle} {
	\bl{Cos'è} {
		...
		\iz {
			...
			\item Magic numbers
			\item Altro: \url{http://checkstyle.sourceforge.net/availablechecks.html}
		}
	}
}
