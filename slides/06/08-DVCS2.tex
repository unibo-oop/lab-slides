...
\begin{frame}[allowframebreaks]{JUnit}
	\begin{block}{Generalità}
		...
		\begin{itemize}
			\item Nello unit testing, ciascun test verifica la funzionalità di uno ed solo componente 
			\begin{itemize}
				\item In realtà, viene spesso ``abusato'' per testare aspetti più vasti
			\end{itemize}
		\end{itemize}
	\end{block}
