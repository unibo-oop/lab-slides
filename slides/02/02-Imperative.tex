...
\fr{Esempio 2: la classe \texttt{ComplexNum}}{
   ...
   \sizedcode{\tiny}{../../workspace/lab02/esempio2/src/oop/lab02/math/ComplexNum.java}
}
...
\fr{Esempio 3: la classe \texttt{UseComplex}}{
   \sizedcode{\tiny}{../../workspace/lab02/esempio3/src/oop/lab02/math/UseComplex.java}
}
...
\fr{Esempio 4: la classe \texttt{UseCalculator}}{
   ...
   \sizedcode{\small}{../../workspace/lab02/esempio4/src/UseCalculator.java}
...
\begin{frame}[allowframebreaks]{Metodologia di lavoro}
	\begin{block}{}
	...
	\begin{block}{}
		...
		\iz{
			...
			\item È consigliabile, qualora lo si ritenga necessario, creare dei metodi d'appoggio per semplificare la scrittura e/o la risoluzione degli esercizi.
			\item È possibile fare riferimento alle funzionalità fornite dalle seguenti classi: 
			\iz {
				\item \texttt{java.util.Arrays}\footnote{\tiny{\url{https://docs.oracle.com/javase/8/docs/api/java/util/Arrays.html}}}
				\item \texttt{java.lang.Math}\footnote{\tiny{\url{https://docs.oracle.com/javase/8/docs/api/java/lang/Math.html}}}
			}
		}
	\end{block}
\end{frame}
