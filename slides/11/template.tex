...
%
\textbf{Andrà realizzata una sotto-sezione separata per ciascuno studente} con un elenco delle classi sviluppate, separando quelle sviluppate in autonomia da quelle sviluppate in collaborazione.
%
Si ricorda, in tal senso, che l'impegno deve giustificare circa 40-50 ore di sviluppo (è normale e fisiologico che approssimativamente la metà del tempo sia impiegata in analisi e progettazione).
...
usarle in modo inopportuno)
		\item Uso di librerie di terze parti (incluso JavaFX)
	\end{itemize}
