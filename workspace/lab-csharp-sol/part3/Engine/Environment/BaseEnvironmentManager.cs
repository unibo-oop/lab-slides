...
namespace Unibo.ISI.ProgramazioneAdOggetti.Esercitazioni
{
  ...
  /// </summary>
  abstract class BaseEnvironmentManager : IEnvironmentManager, IEnvironment
  {
    ...
    // Implementazione di Time come proprietà automatica di sola lettura
    public int Time { get; private set; }

    public int Width 
    { 
      get { return envRect.Width; } 
    }

    public int Height 
    { 
      get { return envRect.Height; } 
    }

    // Utilizza rnd per implementare i metodi Random(...)
