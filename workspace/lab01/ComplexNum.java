class ComplexNum {
    ...
    public static void main(String[] args) {
         ...
         * c1,c2,c3,c4 restituita dal metodo toStringRep() 6) Sommare a c1 c2
         * (somma di due num complessi (a + ib) + (c + id) = (a + c) + i(b + d)
         * 7) Sommare a c2 c4 8) Stampare nuovamente in standard output la
         * rappresentazione testuale di c1,c2,c3,c4 9) Controllare se l'output
         * corrisponde a quanto preventivato 10) Invocare il metodo equal su c3
         * per tre volte, passando come input c1,c2,c4. Stampare il risultato di
         * ciascuna invocazione in standard output 11) Controllare se l'output
         * corrisponde a quanto preventivato
         */
    }
}
