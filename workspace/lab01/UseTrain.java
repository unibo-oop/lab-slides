public class UseTrain {
    ...
    public static void main(String[] args) {
         ...
         * a piacere per i parametri nTotSeats, nFCSeats e nSCSeats (purchè tali
         * valori siano consistenti! p.e. nTotSeats=150, nFCSeats=50 e
         * nSCSeats=100)
         * 
         * 2) Effettuare delle prenotazioni in prima e seconda classe
         * specificando un numero di posti da prenotare consistente (p.e.
         * reserveFCSeats(10))
         * 
