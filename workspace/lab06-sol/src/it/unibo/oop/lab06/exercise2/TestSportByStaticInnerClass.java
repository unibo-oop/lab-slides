...
public final class TestSportByStaticInnerClass {
	...
	public static void main(final String[] args) {
		...
		System.out.println("Alonso does not lime volley: " + !falonso.hasSport(SportSocialNetworkUserImpl.VOLLEY));
		...
		System.out.println("Cassani has been a professional biker: " + dcassani.hasSport(SportSocialNetworkUserImpl.BIKE));
		...
		System.out.println("Bernie's the boss when it comes to F1: " + becclestone.hasSport(SportSocialNetworkUserImpl.F1));
		System.out.println("Bernie does love playing also basket: " + becclestone.hasSport(SportSocialNetworkUserImpl.BASKET));
	}
