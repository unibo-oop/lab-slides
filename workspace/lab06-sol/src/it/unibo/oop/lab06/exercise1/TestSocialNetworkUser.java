...
public final class TestSocialNetworkUser {
    ...
    public static void main(final String[] args) {
        ...
        /*
         * create 5 social network users (SocialNetworkUser): * Kevin Bacon,
         * kbacon, 56 * Denzel Washington, dwashington, 59 * Malcom Gladwell,
         * mgladwell, 51 * Nicholas Taleb, ntaleb, 54
         * 
        ...
        System.out.println("Smith has not set any age at all: "
                + (!asmith.isAgeDefined()));
        final Collection<User> kbaconFriends = kbacon
                .getFollowedUsersInGroup("Malcom");
        System.out
                .println("K Bacon must have no followed people called Malcom: "
                        + kbaconFriends.isEmpty());

        final Collection<User> mgladFriends = mgladwell
                .getFollowedUsersInGroup("Close friends");
        System.out
                .println("M Gladwell has not set yet any group called \"Close friends\": "
                        + mgladFriends.isEmpty());

        final Collection<User> dwashFriends = dwashington
                .getFollowedUsersInGroup("writers");
        System.out
                .println("Denzel has 2 followed people in group \"writers\": "
                        + (dwashFriends.size() == 2));
        ...
        System.out
                .println("Denzel has STILL 2 followed people in group \"writers\": "
