...
public class Professor implements IUser {
	...
	public Professor(final Integer id, final String name, final String surname, final String password, final String[] courses) {
		this.id = id;
		this.name = name;
	...
	public String toString() {
		return "Professor [id=" + this.id + ", name=" + this.name + ", surname=" + this.surname + ", subjects=" + Arrays.toString(this.courses) + "]";
	}
