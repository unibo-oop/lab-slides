...
import it.unibo.oop.lab07.exercise01.PositionOutOfBoundException;
...
public class Robot {
   ...
   * @throws PositionOutOfBoundException if the movement is outside the {@link it.unibo.oop.lab07.exercise04.RobotEnvironment} boundaries
