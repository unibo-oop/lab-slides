...
public class PlayWithSmartphoneArrays {
    ...
    static int search(final Smartphone[] array, final boolean hasNFC,
            final boolean hasGPS) {
        // TODO
        return 0;
    }

    static int search(final Smartphone[] array, final int nCPUs,
            final int sdSize, final boolean has3G) {
        // TODO
        return 0;
    }
