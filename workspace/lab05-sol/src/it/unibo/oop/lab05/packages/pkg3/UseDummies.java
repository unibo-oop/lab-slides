 ...
 * 
 */
package it.unibo.oop.lab05.packages.pkg3;

import it.unibo.oop.lab05.packages.pkg1.DummyClass;
import it.unibo.oop.lab05.packages.pkg1.MinionDummy;
import it.unibo.oop.lab05.packages.pkg2.EvenMoreDummy;
...
public final class UseDummies {
    ...
    public static void main(final String[] args) {
        final DummyClass[] dummies = new DummyClass[] { new DummyClass(), new MinionDummy(), new MoreDummy(),
                new EvenMoreDummy() };
